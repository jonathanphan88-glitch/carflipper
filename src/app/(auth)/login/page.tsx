    ...
    <div className="min-h-screen bg-[#09090f] flex">
      ...
      <div className="hidden lg:flex flex-col justify-between w-96 shrink-0 bg-[#0f0f18] border-r border-white/[0.06] p-10">
        ...
        <div className="space-y-4">
          <p className="text-xs font-semibold uppercase tracking-widest text-zinc-600 mb-2">Example deals</p>
          {[
            ...
            { score: 67, title: "2015 Ford Mustang V6", price: "$8,200", profit: "+$1,900", color: "text-sky-400", border: "border-sky-500/20", bg: "bg-sky-500/8" },
            { score: 74, title: "2017 Subaru WRX", price: "$14,000", profit: "+$2,400", color: "text-sky-400", border: "border-sky-500/20", bg: "bg-sky-500/8" },
          ].map((item, i) => (
            <div key={i} className="flex items-center justify-between gap-4 p-3 bg-[#09090f] border border-white/[0.06] rounded-xl">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-xs text-zinc-600">{item.price}</div>
              </div>
